    ...
    <div className="grid-bg flex min-h-screen items-center justify-center bg-[var(--bg-primary)] px-6 py-10">
      <div className="w-full max-w-[420px]">
        <div className="mb-8 text-center">
          ...
          <h1 className="ui-title text-[28px]">Create Account</h1>
          <p className="mt-2 text-sm text-slate-500">Start your AI powered interview training</p>
        </div>
        ...
        <div className="ui-card p-8">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div>
              <label className="mb-2 block text-[13px] font-medium text-slate-400">Full Name</label>
              <input
                type="text"
                value={name}
          ...
          <p className="mt-5 text-center text-sm text-slate-500">
            ...
            <Link to="/login" className="font-medium text-[var(--cyan)] no-underline hover:underline">
              Login here
            </Link>
          </p>
        </div>
