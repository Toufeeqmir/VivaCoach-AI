...
const FinalStep = ({ state }) => (
  <div className="ui-card-soft mx-auto max-w-5xl border-l-[3px] border-l-[var(--blue)] p-6">
    ...
    <div className="mt-6 flex flex-wrap items-center justify-end gap-3">
      <Link className="ui-btn-ghost no-underline" to="/dashboard">Back to Dashboard</Link>
      <Link className="ui-btn-primary no-underline" to="/report">View Report Card {"->"}</Link>
    </div>
  </div>
);
